...
function getforecast() {
  ...
  fetch(url)
    ...
    .then(data => displayweather(data) // feeding the data from the api to the function 
...
function displayweather(data) {
  ...
  for (let i = 0; i < data.list.length; i += 8) {
    ...
    //displaying the data and letting it multiply using the loop
...
//show cover page again inorder to search again
function openpg() {
  let popU = document.getElementById("cover")
